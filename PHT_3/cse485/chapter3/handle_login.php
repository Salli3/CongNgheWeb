...
// TODO 2: Kiểm tra xem ngffời dùng đã nhấn nút "Đăng nhập" (gửi form) chffa
...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if ($user == 'admin' && $pass == '123') {
        ...
        // TODO 5: Nếu thành công, lffu tên username vào SESSION
        // Gợi ý: $_SESSION['ten_ban_dat'] = $user;

        $_SESSION['username'] = $user;

        // TODO 6: Chuyển hffớng ngffời dùng sang trang "chào mừng"
        ...
        // Nếu thất bại, chuyển hffớng về login.html
        header('Location: login.html?error=1'); // Kèm theo thông báo lỗi trên URL
        exit;
    }

// TODO 7: Nếu ngffời dùng truy cập trực tiếp file này (không qua POST),
